...
fetchFeed session feedTabs page =
    let
        ...
        params =
            PaginatedList.params { page = page, resultsPerPage = resourcesPerPage }
        ...
        request =
            case feedTabs of
                ...
                GlobalFeed ->
                    Api.get (Endpoint.resources params) maybeCred decoder
                ...
                TagFeed tag ->
                    ...
                    in
                    Api.get (Endpoint.resources (firstParam :: params)) maybeCred decoder
    in
    Http.toTask request
